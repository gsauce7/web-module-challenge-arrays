...
is31Flavors(originalFlavors); // returns true , but returns false if I remove an element from the array
...
/* NOTE I DON'T LIKE HOW THIS IS WORDED. The function should accept only one argument. -Gabriel*/
function copy(array){
...
let flavorCopy = copy(originalFlavors);
originalFlavors[2] = "NOT A FLAVOR"
